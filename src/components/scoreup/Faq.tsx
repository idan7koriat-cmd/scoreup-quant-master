...
const faqs = [
  ...
  },
  {
    ...
    a: "בחינם: 3 שאלות ביום עם ניתוח ביצועים בסיסי. מנוי חודשי גמיש עולה ₪99 וניתן לבטל בכל עת. יש גם חבילת מרתון של 60 יום ב-₪149 בתשלום חד-פעמי.",
  },
  {
  ...
  },
  {
    ...
    a: "ScoreUp מתמקד אך ורק בחלק הכמותי — לא מפזר תשומת לב על שאר הבחינה. תרגול נכון וממוקד, עם פתרון מלא ומוסבר לכל שאלה, הוא בדיוק מה שמעלה ציון בחלק הכמותי — ולכן ברוב המקרים אין צורך במורה פרטי בנוסף.",
  },
  {
    q: "זה עובד גם מהנייד?",
