...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    // TikTok Pixel base code — loads the SDK and fires the base "page" event on every route.
    // No specific conversion events are wired up yet; those are configured separately.
    scripts: [
      {
...
;n.type="text/javascript",n.async=!0,n.src=r+"?sdkid="+e+"&lib="+t;e=document.getElementsByTagName("script")[0];e.parentNode.insertBefore(n,e)};
  ...
  ttq.load('DA9LHCBC77UBPDTVJ5P0');
  ttq.page();
}(window, document, 'ttq');`,
      },
      // Meta Pixel base code — loads fbq and fires the base PageView event on every route.
      // No specific conversion events are wired up yet; those are configured separately.
      {
