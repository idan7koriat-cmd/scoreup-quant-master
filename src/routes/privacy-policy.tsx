  ...
  return (
    <LegalLayout title="מדיניות פרטיות – ScoreUp" updatedAt="22 באוגוסט 2026" sections={SECTIONS}>
      ...
      <LegalSection id="signup-messages" title="3. הרשמה ושליחת הודעות">
        ...
        <p>
          3.2 בהרשמה לאתר, המשתמש מאשר ומסכים לכך ששלוחי האתר יהיו רשאים לשלוח אליו הודעות שירותיות,
          עדכוני מידע לימודי, ועדכונים טכניים – בדוא"ל, הודעות טקסט או אמצעים דיגיטליים אחרים.
        </p>
        <p>
          3.3 המשתמש יכול לבקש בכל עת להסיר עצמו מרשימת התפוצה דרך לחיצה על קישור הסרה או פנייה
          ישירה לצוות התמיכה.
        </p>
      </LegalSection>
      ...
      <LegalSection id="sharing-security" title="6. שיתוף מידע עם צדדים שלישיים ואבטחת מידע">
        ...
        <p className="pt-2">
          <span className="font-semibold text-foreground">
            6.5 פיקסלים שיווקיים (לא פעיל כרגע – לעדכן כאשר יופעל קמפיין ממומן):{" "}
          </span>
          ככל שהאתר יעשה שימוש בפיקסלים של פלטפורמות פרסום (כגון Meta / Google Ads / TikTok) לצורך
          מדידת יעילות פרסום ויחוס רכישות, פיקסלים אלו עשויים לאסוף מידע על פעילות המשתמש באתר, כולל
          דפים שנצפו ופעולות שננקטו (כגון רכישות), המועבר לפלטפורמות הפרסום הרלוונטיות לצורך
