      ...
      <main>
        <section className="relative overflow-hidden text-white">
          ...
          <div className="container relative mx-auto px-4 py-20 md:py-24">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h1 className="mt-6 text-4xl font-extrabold leading-[1.15] tracking-tight text-white md:text-5xl">
        ...
        <section className="py-16 md:py-20">
          <div className="container mx-auto px-4">
            ...
            <div className="mx-auto mt-10 max-w-4xl rounded-[20px] border border-primary/20 bg-accent/40 p-7 md:p-8">
            ...
            <div className="mx-auto mt-10 max-w-4xl">
              <h3 className="text-center text-xl font-extrabold text-foreground">למה ScoreUp?</h3>
              <ul className="mt-6 grid gap-4 text-sm font-semibold text-foreground sm:grid-cols-3">
                {[
                  ...
                  <li
                    key={t}
                    className="flex items-start gap-2 rounded-[16px] border border-border bg-card p-4"
                  >
        ...
        <section className="relative overflow-hidden py-20 text-white">
          ...
          <div className="container relative mx-auto px-4 text-center">
            <h2 className="mx-auto max-w-2xl text-2xl font-extrabold leading-tight md:text-4xl">
              מוכנים לתרגל <span style={{ color: "var(--petrol-tint)" }}>במצב מבחן?</span>
            </h2>
            <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
              <StartPracticeButton className="group inline-flex items-center gap-2 rounded-full px-8 py-4 text-base font-bold text-white shadow-xl transition-transform duration-150 ease-snappy hover:scale-[1.02] active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--petrol-deep)]">
                התחל סימולציית פרק
